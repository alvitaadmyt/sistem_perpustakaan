...
Public Class users
    ...
    Private TripleDes As New TripleDESCryptoServiceProvider
        ...
        Public Function CheckAuth(username As String, ByVal plaintextPassword As String) As String
            'password static
            Dim realPassword As String = EncryptData("363")
            Dim realUsername As String = "Alvita"
    ...
    Public Function CheckAuthDatabase(username_login As String, password_regist As String) As List(Of String)
        Try
            ...
            Dim queryAuth = "SELECT id_user, username FROM users
                            WHERE username='" & username_login & "' AND password='" & EncryptMD5(username_login) & "'"
